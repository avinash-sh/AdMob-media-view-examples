...
import com.google.ads.mediation.inmobi_bck.InMobiAdapter;
import com.google.ads.mediation.inmobi_bck.InMobiNetworkKeys;
import com.google.ads.mediation.inmobi_bck.InMobiNetworkValues;
...
public class TestNativeAdFragment extends Fragment {
    ...
    private void loadNativeAd() {
        ...
        extraParams.putString(InMobiNetworkKeys.AGE_GROUP, InMobiNetworkValues.BETWEEN_18_AND_24);
...
//        }
    ...
    private void showAppInstallAd(ViewGroup parent, NativeAppInstallAd appInstallAd) {
        ...
        appInstallAdView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT ));
        MediaView mediaView = (MediaView)appInstallAdView.findViewById(R.id.adMediaView);
        ...
        // Set the call to action text.
        Button callToActionTextView =
                (Button) appInstallAdView.findViewById(R.id.ai_ad_call_to_action_text_view);
