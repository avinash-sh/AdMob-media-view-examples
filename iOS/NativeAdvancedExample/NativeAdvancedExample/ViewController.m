...
static NSString *const TestAdUnit = @"/130868815/7-iOS-DFP-Wall";
...
- (void)adLoader:(GADAdLoader *)adLoader
  ...
  if (nativeAppInstallAd.videoController.hasVideoContent) {
    ...
    appInstallAdView.imageView.hidden = YES;
      ...
      appInstallAdView.mediaView.layer.zPosition = 1;
      double ar = nativeAppInstallAd.videoController.aspectRatio;
